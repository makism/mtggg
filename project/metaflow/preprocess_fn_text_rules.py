text_rules = {
    ...
    "Lifelink": "LIFELINK",
    "Menace (This creature with menace can't be blocked except by two or more creatures.)": "MENACE",
    "Menace": "MENACE",
    "Prowess (Whenever you cast a noncreature spell, this creature gets +1/+1 until end of turn.)": "PROWESS",
    "Prowess": "PROWESS",
